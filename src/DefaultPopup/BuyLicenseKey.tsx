        ...
        <div>
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', gap: '10px', textAlign: 'center', margin: '10px' }}>
                        <img style={{ width: '50%' }} src="WeChatPay.png" />
                        <img style={{ width: '50%' }} src="AliPay.png" />
                    </div>
                    <div style={{}}>
                        <Tag style={{ border: 0 }} color="orange" >导出全部笔记</Tag>
                        <Tag style={{ border: 0 }} color="orange">选择笔记直接复制</Tag>
                    </div>
            ...
            <div style={{
                ...
                <h4>付费后多久拿到许可证</h4>
                <p>北京时间 12:00 ~ 02:00 会在 120 分钟内发送到你的邮箱）</p>
                <h4>许可证会过期吗</h4>
                <p>一次性支付，永久有效</p>
                <h4>联系方式</h4>
                <p>
